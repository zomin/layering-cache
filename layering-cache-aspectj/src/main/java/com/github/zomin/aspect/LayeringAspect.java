...
public class LayeringAspect {
    ...
    @Pointcut("@annotation(com.github.zomin.annotation.Cacheable)")
    public void cacheablePointcut() {
    }

    @Pointcut("@annotation(com.github.zomin.annotation.CacheEvict)")
    public void cacheEvictPointcut() {
    }

    @Pointcut("@annotation(com.github.zomin.annotation.CachePut)")
